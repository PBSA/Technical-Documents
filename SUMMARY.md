...
* [Sidechain Operator Nodes \(SONs\)](technology/sidechain-operator-nodes-sons/README.md)
  ...
  * [Connecting to an existing network](technology/sidechain-operator-nodes-sons/connecting-to-an-existing-network.md)
  * [Setting up a new local network](technology/sidechain-operator-nodes-sons/setting-up-a-new-local-network.md)
