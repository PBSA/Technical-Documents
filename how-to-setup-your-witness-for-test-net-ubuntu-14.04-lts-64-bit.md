...
You can get latest version with chain id, genesis, and github tag here [https://github.com/cryptonomex/graphene/releases](https://github.com/cryptonomex/graphene/releases)

Note: Nodes might gone down as everyone is testing.

## Installation of dependencies

Extracted from instructions here: [https://github.com/cryptonomex/graphene/wiki/build-ubuntu](https://github.com/cryptonomex/graphene/wiki/build-ubuntu), but limited only for witness / cli build.
...
_Download genesis_ **Path specific for Test 5**
...
_Run the witness_ **Current nodes for test 5 \(replace for other tests\)**
...
_See your witness producing blocks and you can Ctrl A Ctrl D to detach from screen._
